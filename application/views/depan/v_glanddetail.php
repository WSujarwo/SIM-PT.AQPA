...
<head>
  ...
  <title>Gland Packing | Aqpa Indonesia</title>
  <meta name="description" content="Distributor resmi GTE Products | penyedia sealing gland packing termurah terbaik terlengkap seluruh indonesia">
  ...
  <!-- Ruby CSS -->
  <link rel="stylesheet" href="<?php echo base_url().'assets/detail/style.css'?>">

  <!-- Color CSS -->
  <!-- <link rel="stylesheet" href="<?php echo base_url().'assets/detail/css/color/color1.css'?>"> -->
  <?php
  $g=$data->row_array();
  ?>
</head>
    ...
    <div class="container">
      ...
      <section id="slider" class="slider2">
        <div class="flexslider ">
          <ul class="slides">
            <li>
              <section id="slider" class="slider2" style="background-image:url('<?php echo base_url().'template/xman/img/slidergland.png'?>')">
                <div class="container">
                  <div class="row">
                    <div class="col-md-7 col-sm-12 col-xs-12" style="background: rgba(46, 46, 46, 0.7);">
                      <div class="text">
                        <h1><strong>GLAND</strong> PACKING</h1>
                        <p>A gland is a type of stuffing box that is used to seal a reciprocating or rotating shaft against a fluid. The most common is the head of a tap called the faucet where the glad is usually packed with string which has been soaked in similar grease or tallow.</p>
                        <div class="button">
        ...
        <!-- Blog -->
        <section style="background: #bcc2bf; padding-top: 30px;" id="blog-single" class="section">
          <div class="container">
            <div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="section-title">
                  <h2 style=" font-size: 30px"><?php echo $g['gland_jenis']; ?></h2>
                </div>
              </div>
            </div>
            <br>
            <div class="row">
              <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="single-news">
                  <div class="news-head">
                    <img src="<?php echo base_url().'assets/images/'.$g['gland_gambar'];?>" alt="#">
                  </div>
                </div>
              </div>
              <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="single-news">
                  <div class="news-body" style="color:#0373fc ">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $g['gland_temp']; ?></td>
                          <td><?php echo $g['gland_ph']; ?></td>
                          <td><?php echo $g['gland_speed']; ?></td>
                          <td><?php echo $g['gland_press']; ?></td>
                        </tr>
                      </tbody>
                    </table>

                    <div style="font-size: 12pt;color:#000"><?php echo $g['gland_desc'];?></div>
                    <h5 class="tags">tags-
                      <li><a href="<?php echo base_url().'thermal'?>">Thermal Jacket Insulation | </a></li>
                      <li><a href="<?php echo base_url().'expansion'?>">Expansion Joint | </a></li>
                      <li><a href="<?php echo base_url().'gland'?>">Gland Packing | </a></li>
                      <!-- <li class="divider"></li> -->
                      <li><a href="<?php echo base_url().'swg'?>">Spiral Wound Gasket | </a></li>
                      <li><a href="<?php echo base_url().'graphite'?>">Graphite Ring | </a></li>
                      <li><a href="<?php echo base_url().'line'?>">Line Pipe & Fitting</a></li>
                    </h5>
                  </div>
                </div>
              </div>
