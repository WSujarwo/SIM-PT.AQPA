...
<head>
  ...
  <title>Album Gallery | Dashboard Aqpa</title>
                      ...
                      <div class="wrapper">
                                ...
                                <ul class="widget widget-menu unstyled">
                                  ...
                                  <ul class="widget widget-menu unstyled">
                                    ...
                                    <ul id="aqpagallery" class="collapse unstyled">
                                      <li class="active"><a href="<?php echo base_url().'admin/album'?>"><i class="icon-copy"></i> Album </a></li>
                        ...
                        <div class="span9">
                                    ...
                                    foreach ($data->result_array() as $i) :
                                     ...
                                     <tr class="odd gradeX"> 
                                      ...
                                      <td style="text-align:center;">
                                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $album_id;?>"><span class="icon-pencil"></span></a>
                                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $album_id;?>"><span class="icon-trash"></span></a>
                                      </td>
                                    </tr>
                                  <?php endforeach;?>
                                </tbody>
                                ...
                                <form class="form-horizontal" action="<?php echo base_url().'admin/album/simpan_album'?>" method="post" enctype="multipart/form-data">
                                  <div class="modal-body">
                                    ...
                                    <div class="control-group">
                                      <label for="inputUserName" class="control-label">Album Name</label>
                                      <div class="controls">
                                    ...
                                    <div class="control-group">
                                      <label for="inputUserName" class="control-label">Cover Album</label>
                                      <div class="controls">
                          ...
                          <?php foreach ($data->result_array() as $i) :
                            ...
                            <div hidden class="modal fade" id="ModalEdit<?php echo $album_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                          ...
                          <?php foreach ($data->result_array() as $i) :
                            ...
                            <div hidden class="modal fade" id="ModalHapus<?php echo $album_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                                  ...
                                  <form class="form-horizontal" action="<?php echo base_url().'admin/album/hapus_album'?>" method="post" enctype="multipart/form-data">
                                    <div class="modal-body">       
                                      <input type="hidden" name="kode" value="<?php echo $album_id;?>"/> 
                                      <input type="hidden" value="<?php echo $album_cover;?>" name="gambar">
                                      <p>Are you sure you want to delete <b>Album <?php echo $album_nama;?></b> ?</p>
