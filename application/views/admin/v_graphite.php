...
<head>
  ...
  <title>Graphite Ring | Dashboard Aqpa</title>
                            ...
                            <div class="span3">
                              ...
                              <ul class="widget widget-menu unstyled">
                                ...
                                <ul id="gteproducts" class="collapse unstyled">
                                  ...
                                  <li class="active"><a href="<?php echo base_url().'admin/graphite'?>"><i class="icon-cogs"></i> Graphite Ring </a></li>
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h2>Graphite Ring / Molded Pictures <a class="btn btn-info " style="float: right; " data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Picture</a></h2> 
                              </div>
                              ...
                              <div hidden class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal row-fluid" action="<?php echo base_url().'admin/graphite/simpan_graphite'?>" method="post" enctype="multipart/form-data">
                              ...
                              <div hidden class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'admin/graphite/update_graphite'?>" method="post" enctype="multipart/form-data">
                                      <div class="modal-body">       
                              ...
                              <div hidden class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'admin/graphite/hapus_graphite'?>" method="post" enctype="multipart/form-data">
                                      <div class="modal-body">       
                                        <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                                        <input type="hidden" value="<?php echo $photo;?>" name="gambar">
