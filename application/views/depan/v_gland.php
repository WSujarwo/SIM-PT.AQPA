...
<head>
  ...
  <meta name="description" content="Distributor resmi GTE Products | Distributor sealing gland packing termurah terbaik terlengkap seluruh indonesia">
        ...
        <ul class="nav-menu">
          ...
          <li class="menu-has-children menu-active" ><a href="#">PRODUCTS</a>
            <ul>
              ...
              <li class=""><a href="<?php echo base_url().'berita'?>">POST</a></li>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="section-title">
                  <h2 style="color: black;">GLAND <span style="color: white">PACKING</span></h2>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              foreach ($data->result_array() as $i) :
               $no++;
               $gland_id=$i['gland_id'];
               $gland_jenis=$i['gland_jenis'];
               $gland_desc=$i['gland_desc'];
               $gland_temp=$i['gland_temp'];
               $gland_ph=$i['gland_ph'];
               $gland_speed=$i['gland_speed'];
               $gland_press=$i['gland_press'];
               $gland_gambar=$i['gland_gambar'];

               ?>

               <div class="col-md-4 col-sm-12 col-xs-12 wow " data-wow-duration="0.8s" data-wow-delay="0.4s">
                <!-- single-news -->
                <div class="single-news">
                  <div class="news-head">
                    <div class="news-date">
                      <span>Temp: <?php echo $gland_temp;?></span> 
                      <span>pH: <?php echo $gland_ph;?></span> 
                      <span>Speed: <?php echo $gland_speed;?></span>
                      <!-- <span>Press: <?php echo $gland_press;?></span>  -->
                    </div>
                    <img src="<?php echo base_url().'assets/images/'.$gland_gambar;?>" alt="#">
                    <<!-- div class="news-view"> 
                      <span><i class="fa fa-eye"></i><?php echo $gland_press;?></span>
                    </div> -->
                  </div>
                  <div class="news-body">
                    <h2><a href="<?php echo base_url().'gland_packing/gland_detail/'.$gland_id;?>"><?php echo limit_words($gland_jenis,4).'...';?></a></h2>
                    <p><?php echo limit_words($gland_desc,10).'...'?></p>
                    <a href="<?php echo base_url().'gland_packing/gland_detail/'.$gland_id;?>" class="btn">Read More<i class="fa fa-angle-double-right"></i></a>
                  </div>
                </div>
              </div>
            <?php endforeach;?>
