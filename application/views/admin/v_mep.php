...
<head>
  ...
  <title>MEP Division| Dashboard Aqpa</title>
                        ...
                        <div class="container">
                          <div class="row">
                            <div class="span3">
                              ...
                              <li class="active"><a href="<?php echo base_url().'admin/mep'?>"><i class="menu-icon icon-tasks"></i>MEP Products <b class="label orange pull-right">
                              </b> </a></li>
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h2>Mechanical, Electrical, Plumbing Pictures <a class="btn btn-info " style="float: right; " data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Picture</a></h2> 
                              </div>
                                    ...
                                    foreach ($data->result_array() as $i) :
                                     ...
                                     <tr class="odd gradeX">
                                      ...
                                      <?php if(empty($photo)):?>
                                        ...
                                        <?php endif;?>
                                        <td><?php echo $nama;?></td>
                                        <?php if($class=='mechanical'):?>
                                          <td>Mechanical</td>
                                          <?php elseif($class=='electrical'):?>
                                            <td>Electrical</td>
                                            <?php else:?>
                                              <td>Plumbing</td>
                                            <?php endif;?>
                                ...
                                <div hidden class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <form class="form-horizontal row-fluid" action="<?php echo base_url().'admin/mep/simpan_mep'?>" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <select tabindex="1" data-placeholder="Select here.." class=""  name="xclass">
                                  ...
                                  <div hidden class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url().'admin/mep/update_mep'?>" method="post" enctype="multipart/form-data">
                                          <div class="modal-body">       
                                              ...
                                              <div class="controls">
                                                <?php if($class=='mechanical'):?>
                                                 <select tabindex="1" data-placeholder="Select here.." class="" name="xclass" >
                                                  ...
                                                  <option value="electrical" >mlectrical</option>
                                                  <option value="plumbing" >plumbing</option>
                                                </select>
                                                <?php elseif($class=='electrical'):?>
                                                 <select tabindex="1" data-placeholder="Select here.." class="" name="xclass" >
                                  ...
                                  <div hidden class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url().'admin/mep/hapus_mep'?>" method="post" enctype="multipart/form-data">
                                          <div class="modal-body">       
                                            <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                                            <input type="hidden" value="<?php echo $photo;?>" name="gambar">
