...
<head>
  ...
  <title>Edit Post | Dashboard Aqpa</title>
                            ...
                            <div class="span3">
                              <div class="sidebar">
                                <ul class="widget widget-menu unstyled">
                                  ...
                                  <li ><a style="background: #fff; color: #000; " onMouseOver="this.style.color='#0373fc'" onMouseOut="this.style.color='#000'" class="collapsed" data-toggle="collapse" href="#news"><i style="color: #000" class="menu-icon icon-paste">
                                  </i><i class="icon-chevron-down pull-right"></i><i class="icon-chevron-up pull-right">
                                  </i >News </a>
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h3>Update Articel / News</h3>
                              </div>
                              <div class="module-body">
                                <?php
                                $b=$data->row_array();
                                ?>
                                <form class="form-horizontal row-fluid" action="<?php echo base_url().'admin/tulisan/update_tulisan'?>" method="post" enctype="multipart/form-data">
                                  <div class="control-group">
                                    <div class="span9">
                                      <input type="hidden" name="kode" value="<?php echo $b['tulisan_id'];?>">
                                      <input type="text"  name="xjudul" class="span12" value="<?php echo $b['tulisan_judul'];?>" placeholder="Title Articel / News" required >
                                    </div>
                                    <div class="span2">
                                      <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-flat pull-right span12"><span class="icon-pencil "></span> Update</button>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="control-group">
