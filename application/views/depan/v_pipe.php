...
<head>
  ...
  <title>Pipe & Steel | Aqpa Indonesia</title>
  <meta name="description" content="Distributor resmi GTE Products | Distributor Pipng System & Steel Structure termurah terbaik terlengkap seluruh indonesia">
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-md-7 col-sm-12 col-xs-12">
                      <div class="text">
                        <h1><strong>STEEL</strong> DIVISION</h1>
                        <p>Steel pipe, Steel Structure, fitting & bolting equipment. Steel Product: Spindo, Bakrie, Gunung Raja Paksi, Benkan, FKK, etc</p>
                        <div class="button">
                          <a href="mailto:info@aqpa-indonesia.com" class="btn primary" ><i class="fa fa-envelope"></i>&nbsp;&nbsp;Email Us &nbsp;&nbsp;</a>
                          <a href="https://wa.me/6281281644425" target="_blank" class="btn"><i class="fa fa-whatsapp"></i>&nbsp;&nbsp;Chat Us&nbsp;&nbsp;</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="section-title">
                  <h2><span>PIPING SYSTEM & STEEL STRUCTURE</span></h2>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="works-menu wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                  <ul>
                    <li data-filter=".pipe"><i class="fa fa-cog"></i>Piping System</li>
                    <li class="active" data-filter="*"><i class="fa fa-tasks"></i>All Products</li>
                    <li data-filter=".steel"><i class="fa fa-cog"></i>Steel Structure</li>
                  </ul>
                </div>
                <!--/ End Project Nav -->
              </div>
