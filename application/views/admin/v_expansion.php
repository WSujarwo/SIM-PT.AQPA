...
<head>
  ...
  <title>Expansion joint | Dashboard Aqpa</title>
                            ...
                            <div class="span3">
                              ...
                              <ul class="widget widget-menu unstyled">
                                ...
                                <ul id="gteproducts" class="collapse unstyled">
                                  ...
                                  <li class="active"><a href="<?php echo base_url().'admin/expansion'?>"><i class="icon-cogs"></i> Expansion Joint </a></li>
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h2>Expansion Joint Fabric & Metal Pictures <a class="btn btn-info " style="float: right; " data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Picture</a></h2> 
                              </div>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped  display" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    foreach ($data->result_array() as $i) :
                                     $no++;
                                     $id=$i['expansion_id'];
                                     $nama=$i['expansion_nama'];
                                     $class=$i['expansion_class'];
                                     $photo=$i['expansion_photo'];
                              ...
                              <div hidden class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal row-fluid" action="<?php echo base_url().'admin/expansion/simpan_expansion'?>" method="post" enctype="multipart/form-data">
                                      <div class="modal-body">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="radio">
                                            <input type="radio" id="inlineRadio2" value="instal" name="xclass">
                              ...
                              <div hidden class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'admin/expansion/update_expansion'?>" method="post" enctype="multipart/form-data">
                                      <div class="modal-body">       
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            ...
                                            <?php else:?>
                                              ...
                                              <div class="radio">
                                                <input type="radio" id="inlineRadio2" value="instal" name="xclass" checked>
                                                <label for="inlineRadio2"> instal </label>
                                              </div>
                                            <?php endif;?>
                                          </div>
                              ...
                              <div hidden class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'admin/expansion/hapus_expansion'?>" method="post" enctype="multipart/form-data">
                                      <div class="modal-body">       
                                        <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                                        <input type="hidden" value="<?php echo $photo;?>" name="gambar">
