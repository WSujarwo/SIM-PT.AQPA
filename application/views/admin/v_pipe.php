...
<head>
  ...
  <title>Pipe & Steel | Dashboard Aqpa</title>
                        ...
                        <div class="container">
                          <div class="row">
                            <div class="span3">
                              ...
                              <li class="active"><a href="<?php echo base_url().'admin/pipe'?>"><i class="menu-icon icon-tasks"></i>Steel Products <b class="label orange pull-right">
                              </b> </a></li>
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h2>Piping system & Steel structure Pictures <a class="btn btn-info " style="float: right; " data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Picture</a></h2> 
                              </div>
                              ...
                              <div hidden class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal row-fluid" action="<?php echo base_url().'admin/pipe/simpan_pipe'?>" method="post" enctype="multipart/form-data">
                                      <div class="modal-body">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                           <div class="radio">
                                            <input type="radio" id="inlineRadio1" value="pipe" name="xclass">
                                            <label for="inlineRadio1"> Pipe</label>
                                          </div>
                                          <div class="radio">
                                            <input type="radio" id="inlineRadio2" value="steel" name="xclass">
                                            <label for="inlineRadio2"> Steel </label>
                                          </div>
                                        </div>
                                      </div>
                              ...
                              <div hidden class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'admin/pipe/update_pipe'?>" method="post" enctype="multipart/form-data">
                                      <div class="modal-body">       
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <?php if($class=='pipe'):?>
                                             <div class="radio">
                                              <input type="radio" id="inlineRadio1" value="pipe" name="xclass" checked>
                                              <label for="inlineRadio1"> Pipe </label>
                                            </div>
                                            <div class="radio">
                                              <input type="radio" id="inlineRadio2" value="steel" name="xclass">
                                            ...
                                            <?php else:?>
                                              ...
                                              <div class="radio">
                                                <input type="radio" id="inlineRadio2" value="steel" name="xclass" checked>
                                                <label for="inlineRadio2"> Steel </label>
                                              </div>
                                            <?php endif;?>
                                          </div>
                              ...
                              <div hidden class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'admin/pipe/hapus_pipe'?>" method="post" enctype="multipart/form-data">
                                      <div class="modal-body">       
                                        <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                                        <input type="hidden" value="<?php echo $photo;?>" name="gambar">
