...
<head>
  ...
  <title>Team | Dashboard Aqpa</title>
                              ...
                              <div class="sidebar">
                                <ul class="widget widget-menu unstyled">
                                  ...
                                  <li><a href="<?php echo base_url().'admin/inbox'?>"><i class="menu-icon icon-inbox"></i>Inbox <b class="label green pull-right">
                                    ...
                                    <li class="active"><a href="<?php echo base_url().'admin/team'?>"><i class="menu-icon icon-group"></i>Team </a></li>
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h2>Team List  <a class="btn btn-info " style="float: right; " data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Team</a></h2> 
                              </div>
                              ...
                              <div class="module-body table">
                                ...
                                <tbody>
                                  ...
                                  foreach ($data->result_array() as $i) :
                                    ...
                                    $id=$i['team_id'];
                                    $nama=$i['team_nama'];
                                 // $jabatan=$i['team_jabatan'];
                                 // $kontak=$i['team_kontak'];
                                    $link=$i['team_linkedin'];
                                    $photo=$i['team_photo'];
                          ...
                          <div hidden class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <form class="form-horizontal row-fluid" action="<?php echo base_url().'admin/team/simpan_team'?>" method="post" enctype="multipart/form-data">
                                  <div class="modal-body">

                                    <div class="control-group">
                                      <label for="inputUserName" class="control-label">Divisi</label>
                                      <div class="controls">
                                        <input type="text" name="xnama" class="span8" id="inputUserName" placeholder="Division" required>
                                      </div>
                                    </div>
                                ...
                                <!-- <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input type="text" name="xjabatan" class="span8" id="inputJabatan" placeholder="Jabatan" required>
                                  </div>
                                </div>

                                <div class="control-group">
                                  <label for="inputKontak" class="control-label">Kontak</label>
                                  <div class="controls">
                                    <input type="text" name="xkontak" class="span8" id="inputKontak" placeholder="Kontak" required>
                                  </div>
                                </div> -->
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input type="email" name="xlink" class="span8" id="inputUserName" placeholder="Email@website.com" required>
                                  </div>
                                </div>
                            ...
                            <div class="modal-content">
                              ...
                              <form class="form-horizontal" action="<?php echo base_url().'admin/team/update_team'?>" method="post" enctype="multipart/form-data">
                                <div class="modal-body">       
                                  ...
                                  <div class="control-group">
                                    <label for="inputUserName" class="control-label">Division</label>
                                    <div class="controls">
                                ...
                                <!-- <div class="control-group">
                                  <label for="inputJabatan" class="control-label">Jabatan</label>
                                  <div class="controls">
                                    <input type="text" name="xjabatan" value="<?php echo $jabatan;?>" class="form-control" id="inputJabatan" placeholder="Jabatan" required>
                                  </div>
                                </div>
                                ...
                                <div class="control-group">
                                  <label for="inputKontak" class="control-label">Kontak</label>
                                  <div class="controls">
                                    <input type="text" name="xkontak" value="<?php echo $kontak;?>" class="form-control" id="inputKontak" placeholder="Kontak" required>
                                  </div>
                                </div> -->
                                ...
                                <div class="control-group">
                                  <label for="inputUserName" class="control-label">Email </label>
                                  <div class="controls">
                                    <input type="email" name="xlink" value="<?php echo $link;?>" class="form-control" id="inputUserName" placeholder="Email@website.com" required>
                                  </div>
                                </div>

                                <div class="control-group">
                                  <label for="inputUserName" class="control-label">Foto </label>
                                  <div class="controls">
                                    <input type="file" name="filefoto"/>
                                  </div>
                                </div>
