...
<head>
  ...
  <title>Gallery | Aqpa Indonesia</title>
...
<body>
        ...
        <ul class="nav-menu">
          ...
          <li class="menu-has-children" ><a href="">PRODUCTS</a>
            <ul>
              ...
              <li class="menu-active"><a href="<?php echo base_url().'galeri'?>">GALLERY</a></li>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="works-menu wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                <ul>
                 <li><a href="<?php echo base_url().'galeri'?>">All Album</a></li>
                 <?php 
                 foreach ($alb->result_array() as $i) {
                  ...
                  <?php if($b['galeri_album_id']==$alb_id):?>
                    <li class="active"><a href="<?php echo base_url().'galeri/album/'.$alb_id;?>" ><?php echo $alb_nama;?></a></li>
                    <?php else:?>
          ...
          <div class="row">
            <div class="isotop-active">
              ...
              foreach ($data->result_array() as $a) {
                ...
                ?>
                <div class="col-md-3 col-sm-3 col-xs-12 gpack">                      
                  <!-- single-work -->
                  <div class="single-work">
                    <img src="<?php echo base_url().'assets/images/'.$gambar?>" alt="">
                    <a href="<?php echo base_url().'assets/images/'.$gambar?>"  class="" title="<?php echo $judul;?>">
  ...
  <!--/ End Footer -->
      ...
      <script src="<?php echo base_url().'template/xman/js/galery-main.js'?>"></script>
