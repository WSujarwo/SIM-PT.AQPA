...
<head>
  ...
  <title>Portofolio | Dashboard Aqpa</title>
                            ...
                            <div class="span3">
                              <div class="sidebar">
                                <ul class="widget widget-menu unstyled">
                                  ...
                                  <ul class="widget widget-menu unstyled">
                                    <li class="active"><a href="<?php echo base_url().'admin/portofolio'?>"><i class="menu-icon icon-briefcase"></i>Portofolio </a></li>
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h2>Portofolio Pictures <a class="btn btn-info " style="float: right; " data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Picture</a></h2> 
                              </div>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped  display" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    foreach ($data->result_array() as $i) :
                                     $no++;
                                     $id=$i['portofolio_id'];
                                     $nama=$i['portofolio_nama'];
                                     $class=$i['portofolio_class'];
                                     $photo=$i['portofolio_photo'];
                            ...
                            <div hidden class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <form class="form-horizontal row-fluid" action="<?php echo base_url().'admin/portofolio/simpan_portofolio'?>" method="post" enctype="multipart/form-data">
                                    <div class="modal-body">
                                      ...
                                      <div class="control-group">
                                        <label for="inputUserName" class="control-label">Class</label>
                                        <div class="controls">
                                         <div class="radio">
                                          <input type="radio" id="inlineRadio1" value="sample" name="xclass" checked>
                                          <label for="inlineRadio1"> sample</label>
                                        </div>
                                        <div class="radio">
                                          <input type="radio" id="inlineRadio1" value="instal" name="xclass">
                                          <label for="inlineRadio2"> instal </label>
                                        </div>
                                      </div>
                                    </div>
                            ...
                            <div hidden class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <form class="form-horizontal" action="<?php echo base_url().'admin/portofolio/update_portofolio'?>" method="post" enctype="multipart/form-data">
                                    <div class="modal-body">       
                                      ...
                                      <div class="control-group">
                                        ...
                                        <div class="controls">
                                          ...
                                          <?php else:?>
                                            <div class="radio">
                                              <input type="radio" id="inlineRadio1" value="sample" name="xclass">
                                              <label for="inlineRadio1"> sample </label>
                                            </div>
                                            <div class="radio">
                                              <input type="radio" id="inlineRadio1" value="instal" name="xclass" checked>
                                              <label for="inlineRadio2"> instal </label>
                                            </div>
                                          <?php endif;?>
                                        </div>
                            ...
                            <div hidden class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <form class="form-horizontal" action="<?php echo base_url().'admin/portofolio/hapus_portofolio'?>" method="post" enctype="multipart/form-data">
                                    <div class="modal-body">       
                                      <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                                      <input type="hidden" value="<?php echo $photo;?>" name="gambar">
