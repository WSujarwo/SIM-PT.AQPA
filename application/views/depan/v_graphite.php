...
<head>
  ...
  <title>Graphite Ring | Aqpa Indonesia</title>
  <meta name="description" content="Distributor resmi GTE Products | Distributor graphite ring / molded termurah terbaik terlengkap seluruh indonesia">
...
<body>
  ...
  <section id="slider" class="slider2">
    <div class="flexslider ">
      <ul class="slides">
        <li>
          <section id="slider" class="slider2" style="background-image:url('<?php echo base_url().'template/xman/img/slidergraphite.png'?>')">
            <div class="container">
              <div class="row">
                <div class="col-md-9 col-sm-12 col-xs-12" style="background: rgba(46, 46, 46, 0.7);">
                  <div class="text">
                    <h1 style="font-size: 30px;">GRAPHITE RING/MOLDED</h1>
                    <p>Graphite rings are die formed compressed graphite rings. They  are flexible and highly impermeable to gases and liquids. Advantage of graphite rings is long life with no hardening deformations. Installation and removal of graphite rings can be done without danger of damage on the sealing faces. Therefore they can be excellent substitute for some types of metal O-rings. </p><br>
                    <p>Graphite rings contains no adhesives or binders and has self lubricating properties and is therefore virtually maintenance free. Due to minimum leakage rates – with certain grades they can meet requirements of TA Luft and "Clean Air" regulations.</p>
                    <div class="button">
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="section-title">
              <h2><span>Graphite Ring / Molded</span></h2>
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="isotop-active">
            ...
            foreach ($data->result_array() as $i) {
             $no++;
             $id=$i['graphite_id'];
             $nama=$i['graphite_nama'];
             $class=$i['graphite_class'];
             $photo=$i['graphite_photo'];
