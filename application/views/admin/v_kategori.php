...
<head>
  ...
  <title>Category Post | Dashboard Aqpa</title>
              ...
              <li class=""><a href="<?php echo base_url().'admin/inbox'?>"><i class="icon-envelope"></i>
                ...
                <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span style="font-size: 18px"><?php echo $c['pengguna_nama'];?>&nbsp;</span>
                              ...
                              <div class="sidebar">
                                <ul class="widget widget-menu unstyled">
                                  ...
                                  <ul id="news" class="collapse unstyled">
                                    ...
                                    <li class="active"><a href="<?php echo base_url().'admin/kategori'?>"><i class="icon-wrench"></i> Kategori </a></li>
                                  </ul>
                                </li>
                              </ul>
                              <ul class="widget widget-menu unstyled">
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h2>Post Category <a class="btn btn-info " style="float: right; " data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Category</a></h2> 
                              </div>
                                    ...
                                    foreach ($data->result_array() as $i) :
                                     ...
                                     <tr>
                                      ...
                                      <td style="text-align:center; width: 100px">
                                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $kategori_id;?>"><span class="icon-pencil"></span></a>
                                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $kategori_id;?>"><span class="icon-trash"></span></a>
                                      </td>
                                    </tr>
                                  <?php endforeach;?>
                                </tbody>
                  ...
                  <?php foreach ($data->result_array() as $i) :
                    ...
                    ?>
                    <!--Modal Edit Pengguna-->
                    <div hidden class="modal fade" id="ModalEdit<?php echo $kategori_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                ...
                <?php foreach ($data->result_array() as $i) :
                  ...
                  <div hidden class="modal fade" id="ModalHapus<?php echo $kategori_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        ...
                        <form class="form-horizontal" action="<?php echo base_url().'admin/kategori/hapus_kategori'?>" method="post" enctype="multipart/form-data">
                          <div class="modal-body">       
                           <input type="hidden" name="kode" value="<?php echo $kategori_id;?>"/> 
                           <p>Are you sure you want to delete <b><?php echo $kategori_nama;?></b> ?</p>
