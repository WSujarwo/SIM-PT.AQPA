...
<head>
  ...
  <title>Customer List | Dashboard Aqpa</title>
          ...
          <div class="container">
            <div class="row">
              <div class="span3">
                ...
                <li class="active"><a href="<?php echo base_url().'admin/customer'?>"><i class="menu-icon icon-book"></i>Customer List</a></li>
              </ul>
              <ul class="widget widget-menu unstyled">
            ...
            <div class="content">
              ...
              <div class="module">
                <div class="module-head">
                  <h2>Customer List  <a class="btn btn-info " style="float: right; " data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Picture</a></h2> 
                </div>
                      ...
                      <div hidden class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <form class="form-horizontal row-fluid" action="<?php echo base_url().'admin/customer/simpan_customer'?>" method="post" enctype="multipart/form-data">
                              <div class="modal-body">
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input type="text" name="xlink" class="span8" id="inputUserName" placeholder="www.website.com" required>
                                  </div>
                                </div>
                              ...
                              <form class="form-horizontal" action="<?php echo base_url().'admin/customer/update_customer'?>" method="post" enctype="multipart/form-data">
                                <div class="modal-body">       
                                  ...
                                  <div class="control-group">
                                    <label for="inputUserName" class="control-label">Link </label>
                                    <div class="controls">
                                      <input type="text" name="xlink" value="<?php echo $link;?>" class="form-control" id="inputUserName" placeholder="Nama" required>
                                    </div>
                                  </div>

                                  <div class="control-group">
                                    <label for="inputUserName" class="control-label">Logo </label>
                                    <div class="controls">
                                      <input type="file" name="filefoto"/>
                                    </div>
                                  </div>
