	...
	function simpan_team(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_team->simpan_team($nama,$link,$photo);
					...
					$this->m_team->simpan_team_tanpa_img($nama,$link);
					echo $this->session->set_flashdata('msg','success');
					redirect('admin/team');
				}
	...
	function update_team(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_team->update_team($kode,$nama,$link,$photo);
	                    ...
	                    redirect('admin/team');
							...
							$this->m_team->update_team_tanpa_img($kode,$nama,$link);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/team');
	            } 
