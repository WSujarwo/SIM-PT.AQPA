...
class M_tulisan extends CI_Model{
	...
	function get_all_tulisan(){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d') AS tanggal, DATE_FORMAT(tulisan_bulan,'%M') AS bulan,DATE_FORMAT(tulisan_tahun,'%y') AS tahun FROM tbl_tulisan ORDER BY tulisan_id DESC");
		return $hsl;
	}
	...
	function get_tulisan_by_kode($kode){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d') AS tanggal, DATE_FORMAT(tulisan_bulan,'%M') AS bulan,DATE_FORMAT(tulisan_tahun,'%y') AS tahun FROM tbl_tulisan where tulisan_id='$kode'");
		return $hsl;
	}
	...
	function get_berita_slider(){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d') AS tanggal, DATE_FORMAT(tulisan_bulan,'%M') AS bulan,DATE_FORMAT(tulisan_tahun,'%y') AS tahun FROM tbl_tulisan where tulisan_img_slider='1' ORDER BY tulisan_id DESC");
		return $hsl;
	}
	function get_berita_home(){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d') AS tanggal, DATE_FORMAT(tulisan_bulan,'%M') AS bulan,DATE_FORMAT(tulisan_tahun,'%y') AS tahun FROM tbl_tulisan where tulisan_img_slider='0' ORDER BY tulisan_id DESC limit 3");
		return $hsl;
	}

	function berita_perpage($offset,$limit){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d') AS tanggal, DATE_FORMAT(tulisan_bulan,'%M') AS bulan,DATE_FORMAT(tulisan_tahun,'%y') AS tahun FROM tbl_tulisan ORDER BY tulisan_id DESC limit $offset,$limit");
		return $hsl;
	}
	...
	function cari_berita($keyword){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d') AS tanggal, DATE_FORMAT(tulisan_bulan,'%M') AS bulan,DATE_FORMAT(tulisan_tahun,'%y') AS tahun FROM tbl_tulisan WHERE tulisan_judul LIKE '%$keyword%'");
		return $hsl;
	}
