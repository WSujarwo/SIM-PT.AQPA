...
<head>
  ...
  <title>Removable Thermal Insulation | Aqpa Indonesia</title>
  <meta name="description" content="Distributor resmi GTE Products | Distributor penyedia thermal insulation termurah terbaik terlengkap seluruh indonesia">
    ...
    <div class="container">
        ...
        <ul class="nav-menu">
          ...
          <li class="menu-has-children menu-active" ><a href="">PRODUCTS</a>
            <ul>
              ...
              <li><a href="<?php echo base_url().'berita'?>">POST</a></li>
              <li><a href="<?php echo base_url().'galeri'?>">GALLERY</a></li>
              <li class=""><a href="<?php echo base_url().'kontak'?>">CONTACT US</a></li>
            </ul>
          </nav>
        </div>
      </header>
      ...
      <section id="slider" class="slider2">
        <div class="flexslider ">
          <ul class="slides">
            <li>
              <section id="slider" class="slider2" style="background-image:url('<?php echo base_url().'template/xman/img/slider2.png'?>')">
                <div class="container">
                  <div class="row" >
                    <div class="col-md-9 col-sm-12 col-xs-12" style="background: rgba(46, 46, 46, 0.7);">
                      <div class="text" >
                        <h1 style="font-size: 30px;">REMOVABLE THERMAL INSULATION</h1>
                        <h3 style="color:#0373fc ">What is Removable Thermal Insulation?</h3>
                        <p>Thermal Insulation is a material or combination of various materials general usability is to resist the flow of heat transfer.</p><br>
                        <h3 style="color:#0373fc ">What causes heat transfer?</h3> 
                        <p>Temperature difference that causes the heat transfer.</p><br>
                        <h3 style="font-size: 20px; color:#0373fc">Loss or profit when using Thermal Insulation?</h3>
                        <p>There is a term insulation “pays for itself”. Thermal insulation is an investment that is needed in the industry for a reason energy saving. Losses will be felt at the beginning of the year the investment is the installation of insulation but the benefits will be felt in the long term.</p>
                        <div class="button">
                          <a href="" class="btn primary dropdown-toggle" data-toggle="dropdown"><i class="fa fa-briefcase"></i>Other GTE Products &nbsp;&nbsp; <span class="caret"></span></a>
        ...
        <!--/ End skill --> 
        <!-- Start skill -->
        <section id="latest-works" class="latest-works section" style="padding-top: 15px;">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <div class="section-title">
                  <h2><span>Removable Thermal Insulation</span></h2>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="works-menu wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                  <ul>
                    <li data-filter=".sample"><i class="fa fa-cog"></i>Sample Aplication</li>
                    <li class="active" data-filter="*"><i class="fa fa-tasks"></i>All Photo</li>
                    <li data-filter=".instal"><i class="fa fa-cogs"></i>Instalation On Site</li>
                  </ul>
                </div>
                <!--/ End Project Nav -->
              </div>
            ...
            <div class="row">
              <div class="isotop-active">
                ...
                foreach ($data->result_array() as $i) {
                 ...
                 $id=$i['thermal_id'];
                 $nama=$i['thermal_nama'];
                 $class=$i['thermal_class'];
                 $photo=$i['thermal_photo'];

                 ?>
                 <div class="col-md-3 col-sm-3 col-xs-12 <?php echo $class?>">
                  <!-- single-work -->
                  <div class="single-work">
                    <img src="<?php echo base_url().'assets/images/'.$photo;?>" alt="#">
                    <a href="<?php echo base_url().'assets/images/'.$photo;?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="section-title">
                    <h2 style="color: grey">CUSTOMER <span>LIST</span></h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel clients-slider">
                    <?php
                    foreach ($cust->result_array() as $i) {
                        $id=$i['customer_id'];
                        $nama=$i['customer_nama'];
                        $link=$i['customer_link'];
                        $photo=$i['customer_photo'];
