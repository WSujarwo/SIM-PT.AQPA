...
<head>
  ...
  <title>List Post | Dashboard Aqpa</title>
                              ...
                              <div class="sidebar">
                                <ul class="widget widget-menu unstyled">
                                  ...
                                  <ul id="news" class="collapse unstyled">
                                    <li class="active"><a href="<?php echo base_url().'admin/tulisan'?>"><i class="icon-list"></i> List </a></li>
                          ...
                          <div class="content">
                            ...
                            <div class="module">
                              <div class="module-head">
                                <h2>List All Post <a class="btn btn-info " style="float: right; " href="<?php echo base_url().'admin/tulisan/add_tulisan'?>"><span class="fa fa-plus"></span> Add Post</a></h2> 
                              </div>
                                    ...
                                    foreach ($data->result_array() as $i) :
                                     ...
                                     <tr class="odd gradeX"> 
                                      ...
                                      <td style="text-align:center;">
                                        <a class="btn" href="<?php echo base_url().'admin/tulisan/get_edit/'.$tulisan_id;?>"><span class="icon-pencil"></span></a>
                                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $tulisan_id;?>"><span class="icon-trash"></span></a>
                                      </td>
                                    </tr>
                                  <?php endforeach;?>
                                </tbody>
                      ...
                      <div class="modal-content">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url().'admin/tulisan/hapus_tulisan'?>" method="post" enctype="multipart/form-data">
                          <div class="modal-body">       
                            ...
                            <p>Are you sure you want to delete <b><?php echo $tulisan_judul;?></b> ?</p>
